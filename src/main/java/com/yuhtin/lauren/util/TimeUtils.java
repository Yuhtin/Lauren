...
public enum TimeUtils {
    ...
    public static String formatTime(long time) {
        ...
        if(hours > 0)  sb.append(days > 0 ? (minutes > 0 ? ", " : " e ") : "").append(hours).append(hours == 1 ? " hora" : " horas");
        if(minutes > 0)  sb.append(days > 0 || hours > 0 ? (second > 0 ? ", " : " e ") : "").append(minutes).append(minutes == 1 ? " minuto" : " minutos");
        if(second > 0)  sb.append(days > 0 || hours > 0 || minutes > 0 ? " e " : (sb.length() > 0 ? ", " : "")).append(second).append(second == 1 ? " segundo" : " segundos");
